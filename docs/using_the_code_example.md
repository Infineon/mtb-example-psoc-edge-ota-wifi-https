...
The following example clones the "**OTA Wi-Fi HTTPS**" application with the desired name "My_OTA_HTTPS_example" configured for the *KIT_PSE84_EVAL_EPC2* BSP into the specified working directory, *C:/mtb_projects*:

   ```
   project-creator-cli --board-id KIT_PSE84_EVAL_EPC2 --app-id mtb-example-psoc-edge-ota-wifi-https --user-app-name My_OTA_HTTPS_example --target-dir "C:/mtb_projects"
   ```
